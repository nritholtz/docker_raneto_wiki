var config = {
  ...
  site_title: 'Our Wiki Page',

  // The base URL of your site (can use %base_url% in Markdown files)
  base_url: '',

  //Github repository URL for the Wiki
  github_url: 'https://github.com/nritholtz/docker_raneto_wiki',

  // Used for the "Get in touch" page footer link
  support_email: 'nathaniel.ritholtz@idt.net',
